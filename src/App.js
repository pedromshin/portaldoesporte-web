...
function App() {
  ...
  return (
    <div className="App">
      ...
      <>
        <h1>Privacy Policy of Portal do Esporte</h1>

        <p>
          Portal do Esporte operates the https://portaldoesporte-web.vercel.app
        ...
        <p>
          ...
          anyone decided to use our Service, the Portal do Esporte website.
        </p>
        ...
        <p>
          ...
          https://portaldoesporte-web.vercel.app/, unless otherwise defined in
          this Privacy Policy.
        </p>
